...
if ($result->num_rows === 1) {
    ...
    if ($purpose === "registration") {
        ...
        $conn->query(
            "CREATE TABLE $inbox_table (id INT AUTO_INCREMENT PRIMARY KEY, sender_id INT NOT NULL, payload TEXT NOT NULL, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (sender_id) REFERENCES users(id) ON DELETE CASCADE)",
        );
